<section class="main-content">				
	<div class="row">
		<div class="span5">					
			...
			<div class="span7">					
				...
				<form action="/register_action.php"  id='form2' method="post" class="form-horizontal">
					<fieldset>
			<div class="control-group">
				<label class="control-label" for="nama">Nama pelanggan</label>
			<div class="controls">
			<input type="text" name='nama' value='' class='required'>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name='telp' id='telp' value='' class='required'>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" >Kota</label>
		<div class="controls">
			<input type="text" name='kota' id='kota' value='' class='required'
			>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name='kodepos' id='kodepos' value='' class='required'
			>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		<div class="controls">
			<button type="submit" class="btn btn-success" name='aksi'value='register'>Register</button>
		</div>
	</div>
	</fieldset>
</form>					
